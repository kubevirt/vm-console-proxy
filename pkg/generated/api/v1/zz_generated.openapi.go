...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubevirt.io/vm-console-proxy/api/v1.TokenResponse":              schema_kubevirtio_vm_console_proxy_api_v1_TokenResponse(ref),
	}
}
...
func schema_kubevirtio_vm_console_proxy_api_v1_TokenResponse(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
