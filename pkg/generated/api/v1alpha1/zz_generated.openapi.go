...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/kubevirt/vm-console-proxy/api/v1alpha1.TokenResponse": schema_kubevirt_vm_console_proxy_api_v1alpha1_TokenResponse(ref),
...
func schema_kubevirt_vm_console_proxy_api_v1alpha1_TokenResponse(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "TokenResponse is the response object from /token endpoint.",
				Type:        []string{"object"},
